...
export default function ChurchYearScreen() {
        ...
        {content.churchYear.seasons.map((season, index) => {
          ...
          return (
            <View key={index} className="bg-surface dark:bg-surface-dark mb-4 mx-6 rounded-2xl px-5 py-4">
              <Text
                className="text-[#2D2A24] dark:text-[#E8E4DC] mb-3 text-lg"
                style={{ fontFamily: "ReadingFont", fontWeight: "600" }}
              >
                {season.name}
              </Text>
              ...
              <Text
                className="text-[#2D2A24] dark:text-[#E8E4DC] mb-3 text-base leading-relaxed"
                style={{ fontFamily: "ReadingFont", fontWeight: "400" }}
              >
                {season.purpose}
              </Text>
